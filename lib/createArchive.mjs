 ...
 */
export default function (filepath, files, options, override = false, useBinary = '7z') {
  return when.promise(function (resolve, reject, progress) {
    ...
    let command = useBinary + ' a "' + filepath + '" ' + files;

    // Start the command
    Run(command, options, override, useBinary)
